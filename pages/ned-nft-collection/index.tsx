        ...
        <>
            ...
            <div className='container p-8 mx-auto xl:px-0 flex flex-wrap flex-row'>
                <div className="w-full mb-24">
                    ...
                    <p className="text-white">A new level of interaction with DeFi wallets, what we call <span className="text-ned-green">NFT membership</span> or <span className="text-ned-green">NFTop</span></p>
                </div>
