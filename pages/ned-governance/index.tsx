        ...
        <>
            ...
            <div className='container p-8 mx-auto xl:px-0 flex flex-wrap flex-row'>
                <div className="w-full mb-24">
                    <h1 className='text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-6xl lg:leading-tight xl:text-8xl xl:leading-tight text-transparent bg-clip-text bg-gradient-to-r from-ned-green to-ned-blue font-calSans w-min'>Governance</h1>
                    <p className="text-white"><span className="text-ned-green">Ned Finance</span> will move forward in a <span className="text-ned-green">decentralized way</span> through <span className="text-ned-green">Ned Finance DAO</span></p>.
                </div>

                <Benefits data={featureOne} />

                <Benefits imgPos='right' data={featureTwo} />
