		...
		<>
			<div className="container p-8 mx-auto xl:px-0 text-white font-light max-w-screen-xl">
				...
				<p className="my-2">
					...
					before using the software app provided at ned.finance, Ned Finance
					browser extension, and Ned Finance mobile apps (the Service), operated
					by Ned Finance, EIRL.
				</p>
				...
				<p className="my-2">
					...
					Content as permitted by applicable law. You agree that you are solely
				...
				<p className="my-2">
					...
					that are not owned or controlled by Ned Finance, Eirl.
				</p>
				...
				<p className="my-2">
					...
					and the “look and feel” of https://ned.finance and its associated
					...
					Content includes NEDTM and related stylized “ned” designs, which are
					common law trademarks of Ned Finance, Eirl. You may not reproduce,
					republish, distribute, display, perform, transmit, sell, or otherwise
					use any Site Content without our express written permission, except
					when such actions occur in connection with bona fide uses of the
					Service through our publicly supported interfaces. In this regard,
					users are prohibited from downloading, republication, retransmission,
					reproduction, or other use of any image (and other similar content) as
					a stand-alone file. Furthermore, Site Content may not be used in any
				...
				<p className="my-2">
					...
					please notify us at support@ned.finance. Your notice should include:
				</p>
				...
				<ul className="list-disc ml-4">
					...
					<li>
						...
						allegedly infringing material on the Site is not authorized;
					</li>
					<li>Your physical or electronic signature; and</li>
					<li>
						A statement that you are the copyright owner or an authorized agent
						of the copyright owner, including any applicable United States
						copyright registration number(s).
					</li>
				</ul>
				...
				<p className="my-2">
					The Service is created and controlled by Ned Finance, Eirl. in the
					State of California, United States of America. You agree that these
					...
					law provisions. You agree that all legal proceedings arising out of or
					in connection with these Terms of Use or the Service must be brought
					in a federal or state court located in San Francisco, California, and
					that your claim(s) will be forever waived and barred unless filed
					within one year of the time in which the event(s) giving rise to such
					claim(s) began. You expressly submit to the exclusive jurisdiction of
